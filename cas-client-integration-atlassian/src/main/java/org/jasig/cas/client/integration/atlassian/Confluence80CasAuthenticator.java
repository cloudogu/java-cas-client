...
public final class Confluence80CasAuthenticator extends ConfluenceAuthenticator {
    ...
    public Principal getUser(final HttpServletRequest request, final HttpServletResponse response) {
        ...
        // Do not synchronize directory if the user is nil because this could lead to heavy load and application freeze
        // where confluence contains many plugins (including linchpin) and runs in anonymous mode.
